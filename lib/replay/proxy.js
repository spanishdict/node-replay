...
ProxyRequest = (function(superClass) {
  extend(ProxyRequest, superClass);

  function ProxyRequest(options, proxy) {
    var host, n, port, protocol, ref, ref1, v;
    if (options == null) {
      options = {};
    }
    this.proxy = proxy;
    ...
    ref = (options.host || options.hostname).split(":"), host = ref[0], port = ref[1];
  ...
  ProxyRequest.prototype.end = function(data, encoding, callback) {
    ...
    if (typeof data === 'function') {
      ref = [data, null], callback = ref[0], data = ref[1];
    } else if (typeof encoding === 'function') {
      ref1 = [encoding, null], callback = ref1[0], encoding = ref1[1];
    }
    if (data) {
      this.body || (this.body = []);
...
ProxyResponse = (function(superClass) {
  extend(ProxyResponse, superClass);
